...
if __name__ == "__main__":
    ...
    submissionsModule2 = __import__(argv[3])
    classAgent2Module = getattr(submissionsModule, argv[4])
    classAgent2 = getattr(classAgent2Module, argv[4])
